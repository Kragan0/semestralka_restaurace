...
using UTB.Restauracia.Application.Extension;
...
namespace UTB.RestauraciaWeb.Areas.Customer.Controllers
{
    ...
    public class CustomerOrderCartController : Controller
    {
        ...
        [HttpPost]
        public double AddOrderItemsToSession(int? foodId)
        {
            if (HttpContext.Session != null && HttpContext.Session.IsAvailable)
            {
                ...
                totalPrice = _orderCartService.AddOrderItem(foodId, orderItems, totalPrice);
