...
using UTB.Restauracia.Infrastructure.Database.Configuration.MySQL;


namespace UTB.Restauracia.Infrastructure.Database
{
    public class RestauraciaDbContext : IdentityDbContext<Identity.User, Role, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Prepojenie ASPNetUsera s entitami

            modelBuilder.ApplyConfiguration<Order>(new OrderConfiguration());
            
            modelBuilder.Entity<Favorite>().HasOne<User>(e => e.User as User);
            modelBuilder.Entity<Reservation>().HasOne<User>(e => e.User as User);
