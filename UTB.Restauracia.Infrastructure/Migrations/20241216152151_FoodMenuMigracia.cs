...
{
    /// <inheritdoc />
    public partial class FoodMenuMigracia : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Menu",
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "Zakladne jedla" });
            ...
            migrationBuilder.InsertData(
                table: "Food",
                columns: new[] { "Id", "Description", "Icon", "MenuId", "Name", "Price" },
                values: new object[,]
                {
                    { 1, "Rezance s kečupom", "...", 1, "Bolongske Spagheti", 120.0 },
                    { 2, "Syrová pizza", "...", 1, "Pizza Margharita", 180.0 },
                    { 3, "Pravda, chvíľu treba žut, ale chutia príjemne", "...", 1, "Bryndzové Halušky", 240.0 }
                });
